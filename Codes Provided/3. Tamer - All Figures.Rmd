...
my_stopwords <- read.table("./data/ar_stop_complete_list_processed.txt", header = TRUE)
...
As can be seen in the figure, the distribution of word length is almost the same across the 9 half decades. Most words range from 4-5 characters in length.
